...
echo_and_run cd "/home/andrew/NCRL/AprilTag_Localization/src/Env&Ctrl/multirotor_geometry_control/rotors_simulator/rotors_evaluation"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/andrew/NCRL/AprilTag_Localization/src/Env&Ctrl/multirotor_geometry_control/rotors_simulator/rotors_evaluation/setup.py" \
     \
    build --build-base "/home/andrew/NCRL/AprilTag_Localization/build/Env&Ctrl/multirotor_geometry_control/rotors_simulator/rotors_evaluation" \
    install \
    --root="${DESTDIR-/}" \
